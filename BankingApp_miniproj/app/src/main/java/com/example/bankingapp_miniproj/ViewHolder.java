...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.bankingapp_miniproj.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.bankingapp_miniproj.ViewHolder.ClickListener clickListener){
