...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.bankingapp_miniproj.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.example.bankingapp_miniproj.HistoryList historyList, List<Model> modelList) {
